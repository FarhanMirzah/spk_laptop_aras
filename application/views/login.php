...
<html lang="en">
    ...
    <body class="bg-gradient-info">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-info" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-laptop mr-2"></i> Sistem Pendukung Keputusan Pemilihan Laptop - Metode ARAS</a>
            </div>
        </nav>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">SPK Pemilihan Laptop - Metode ARAS</h4>
                            <p class="pt-4">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <form class="user" action="<?php echo site_url('Login/login'); ?>" method="post">
                                            ...
                                            <button name="submit" type="submit" class="btn btn-info btn-user btn-block"><i class="fas fa-fw fa-sign-in-alt mr-1"></i> Login sebagai Admin / Karyawan</button>
                                        </form>

                                        <form class="user" action="<?php echo site_url('Login/masuk_user'); ?>" method="post">
                                            <hr class="sidebar-divider">
                                            <button name="masuk" type="submit" class="btn btn-primary btn-user btn-block"><i class="fas fa-fw fa-caret-right mr-1"></i> Masuk sebagai User / Pelanggan (tanpa login)</button>
                                        </form>
